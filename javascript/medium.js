...
// 21 22 23 24
// 31 32 33 34
// 41 42 43 44 using this format

function returnIndex(num) {
  if (num == 11) return 0;
  else if (num == 12) return 1;
  else if (num == 13) return 2;
  else if (num == 14) return 3;
  else if (num == 21) return 4;
  else if (num == 22) return 5;
  else if (num == 23) return 6;
  else if (num == 24) return 7;
  else if (num == 31) return 8;
  else if (num == 32) return 9;
  else if (num == 33) return 10;
  else if (num == 34) return 11;
  else if (num == 41) return 12;
  else if (num == 42) return 13;
  else if (num == 43) return 14;
  else if (num == 44) return 15;
}
...
function generateAndCheckPuzzle() {
  ...
  let parts = [
    "../image2/row-1-column-1.png",
    "../image2/row-1-column-2.png",
    "../image2/row-1-column-3.png",
    "../image2/row-1-column-4.png",
    "../image2/row-2-column-1.png",
    "../image2/row-2-column-2.png",
    "../image2/row-2-column-3.png",
    "../image2/row-2-column-4.png",
    "../image2/row-3-column-1.png",
    "../image2/row-3-column-2.png",
    "../image2/row-3-column-3.png",
    "../image2/row-3-column-4.png",
    "../image2/row-4-column-1.png",
    "../image2/row-4-column-2.png",
    "../image2/row-4-column-3.png",
  ...
  let tileElements = parts.map((curr, i) => {
    ...
    tile.style.backgroundImage = `url(../${curr})`;
    tile.id = `tile-${i + 1}`;
  ...
  function shuffleTiles() {
    ...
    if (!isSolvable(shuffledArrayIndex)) {
      alert("Puzzle Not Solvable, wait while we shift tiles......");
      shuffleTiles();
    }
  }
